...
/**
 * Classe Main que testa metodos da classe AplicacaoPessoa
 * 
 * @author franck
 *
 */
public class ClienteTestePessoa {
	...
	public static void main(String[] args) {
		...
		try {
			...
			aplicacao.pessoaExiste(aplicacao.getPessoa(3));

			aplicacao.getPessoa(4);

			aplicacao.getPosicao(aplicacao.getPessoa(2));

			for (int i = 1; i <= aplicacao.getPessoas().getTamanho(); i++) {
				System.out.println(aplicacao.getPessoa(i));
			}
